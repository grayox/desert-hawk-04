...
// import Error404 from 'my-app/views/Error404';
...
// import Settings from 'my-app/views/settings/Settings';
// import Feedback from 'my-app/views/feedback/Feedback';
// import Help from 'my-app/views/Help';
// import Logout from 'my-app/views/Logout';
...
class Routes extends Component {
  render() {
    ...
    // const Settings = FuseLoadable({loader: () => import('my-app/views/settings/Settings')});
    ...
    return (
      ...
      // // success
      // <Switch>
      //   <Route path='/'    exact component={FuseLoadable({loader: () => import('my-app/views/dashboard/Dashboard' )})} />
      //   <Route path='/login'     component={FuseLoadable({loader: () => import('my-app/views/dashboard/Dashboard' )})} />
      //   <Route path='/dashboard' component={FuseLoadable({loader: () => import('my-app/views/dashboard/Dashboard' )})} />
      ...
      //     <Route path='/xsettings'  component={FuseLoadable({loader: () => import('my-app/views/settings/Settings')})} />
      //     <Route path='/xsettings'  component={Settings} />
      //   <Route path='/settings'  component={componentsNavConfig[6].component()} />
      //   <Route path='/feedback'  component={FuseLoadable({loader: () => import('my-app/views/Feedback'       )})} />
      //   <Route path='/help'      component={FuseLoadable({loader: () => import('my-app/views/Help'           )})} />
      //   <Route path='/logout'    component={FuseLoadable({loader: () => import('my-app/views/Logout'         )})} />
      //   <Route                   component={FuseLoadable({loader: () => import('my-app/views/Error404'       )})} />
      // </Switch>
      ...
      <div className={classes.wrapper}>
        <Switch>
          ...
          <Route path='/' exact component={FuseLoadable({loader: () => import('my-app/views/dashboard/DashboardContainer')})} />
          <Route path='/login'  component={FuseLoadable({loader: () => import('my-app/views/dashboard/DashboardContainer')})} />
          {
